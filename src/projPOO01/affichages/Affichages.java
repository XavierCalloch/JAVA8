...
/** Classe permettant d'afficher toutes les données de l'entrepise et notamment les salariés,
...
public class Affichages {
	...
	/**
	 * Méthode qui affiche les données de l'entrepise
	 */
	...
	/** Méthode qui affiche les personnes d'une liste de personnes donnée
	 * @param list
	 */
	...
	/** Méthode qui groupe l'affichage des personnes d'une liste donnée
